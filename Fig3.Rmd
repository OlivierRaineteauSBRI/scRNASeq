...
Marcy <- readRDS("~/BioInfo/newdataset/improved_clb_v6.rds")
...
Merge.anchors <- FindIntegrationAnchors(object.list = reference.list, reduction = "rpca", dims = 1:100)
...
Merge.integrated <- RunUMAP(Merge.integrated, dims = 1:19)
```
...
Idents(Merge.integrated) = "merge_simplified_clusters"
DimPlot(Merge.integrated, reduction = "umap", pt.size = 0.5, split.by = "Condition",cols=c("#ADADAD","#ADADAD","#ADADAD","#ADADAD","#ADADAD",
