...
DotPlot(P12, features = c("Gsx2","Six3","Rorb","Eno1","Id4","Id3","Id2","Id1","Hopx","Fezf2","Dmrta2","Zic5","Tfap2c","Emx1"), idents = c("P12_qNSC1","P12_qNSC2","P12_qNSC3"), dot.scale = 10)+scale_colour_viridis(option="viridis")+theme_grey()+RotatedAxis()
```
...
suppressWarnings(rankings10 %>%
  ...
  ylab("AUCell score")+theme_ipsum()+ scale_x_discrete("class", limits = c("P12_qNSC1", "P12_qNSC2","P12_Astrocytes"))+
